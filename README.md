...
2. 게임 진행 로직 구현
  - [ ] Console API 사용하여 사용자의 숫자 입력 구현
  - [ ] 사용자의 수와 컴퓨터의 수 비교하여 볼 개수 구하기
  - [ ] 사용자의 수와 컴퓨터의 수 비교하여 스트라이크 개수 구하기
  - [ ] 3스트라이크 달성 전까지 게임 계속 진행되도록 구현

3. 게임 종료 로직 구현
  - [ ] 3스트라이크 달성 후, 게임을 새로 시작하거나 종료시키는 경우 구현
  - [ ] 사용자가 잘못된 값을 입력할 경우 종료되도록 구현
